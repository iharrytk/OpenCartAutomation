...
public class AccountsPageTest extends BaseTest {
	//Precondition-To validate test cases in AccountsPage,We need to login using doLogin method from LoginPage class.
	...
	// Validate if the URL of Account Page is displayed as per the requirement and has
	// the word account
	@Test
	...
	//Validate the Account Page Headers List is as the given expected list of values.
	@Test
	...
	//Validate if the right panel Links contains My Account link in the AccountsPage
	@Test
