...
public class RegistrationPageTest extends BaseTest {
	...
	public Object[][] userRegistrationData() {
		...
		return new Object[][] {
			{"alex","xander","4587857452","alex","No"},
			{"coco","channel","4587857452","coco","Yes"},
			{"dax","daxxy","4585289632","daxxy","No"}
		};
	}
	...
	//Validate whether we the user is able to perform registration in the Register Page
	@Test(dataProvider="userRegistrationData")
	public void doregisterTest(String firtname,String lastname,String phonenumber,String password,String subscribe) {
